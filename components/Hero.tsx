    ...
    >
      ...
      <div className="w-full flex justify-start items-center relative">
        ...
        <div className="absolute top-60 right-10">
          <div className="w-fit min-w-[200px] text-theme1-accent2 relative">
          ...
          <div className="w-fit min-w-[210px] text-theme1-secondary">
        ...
        <div className="absolute -left-[120px] bottom-55 flex items-center gap-2">
          <a
            className="text-[26px] font-bold text-theme1-accent2 "
            href="#projects"
          >
            VIEW PROJECTS
          </a>
